...
/* In a future release of Bison, this section will be replaced
   by #include "lib_parse.hpp".  */
#ifndef YY_LIB_LIB_PARSE_HPP_INCLUDED
# define YY_LIB_LIB_PARSE_HPP_INCLUDED
/* Debug traces.  */
#ifndef LIBDEBUG
# if defined YYDEBUG
#if YYDEBUG
...
/* Value type.  */
#if ! defined LIBSTYPE && ! defined LIBSTYPE_IS_DECLARED
...
# define LIBSTYPE_IS_TRIVIAL 1
# define LIBSTYPE_IS_DECLARED 1
#endif


extern LIBSTYPE liblval;

int libparse (void);

#endif /* !YY_LIB_LIB_PARSE_HPP_INCLUDED  */
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined LIBSTYPE_IS_TRIVIAL && LIBSTYPE_IS_TRIVIAL)))
...
#if LIBDEBUG || YYERROR_VERBOSE || 0
/* YYTNAME[SYMBOL-NUM] -- String name of the symbol SYMBOL-NUM.
   First, the terminals, then, starting at YYNTOKENS, nonterminals.  */
static const char *const yytname[] =
{
  "$end", "error", "$undefined", "PINS", "LIB_NAME", "LIB_MODULE",
  "PRIMITIVE", "$accept", "library", "L_prim", "L_mod", "pinlist", YY_NULLPTR
};
#endif
